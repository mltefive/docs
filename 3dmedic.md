### 3Dmedic
 ...
 - Рабочий Web прототип, предварительно надо скачать [DICOM файлы](http://194.87.102.175/3dmedic/lukas_3d_dicom.zip), разархивировать
 - Открыть [Demo](http://194.87.102.175/3dmedic/) загрузить файлы Dicom или директорию (много файлов не загружать - зависнет)
 - Ковертация в 3D [пример](http://45.11.27.40/demo2.stl) (в работе)
