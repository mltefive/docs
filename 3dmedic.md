...
- Импорт, предварительная обработка и подготовка DICOM (томография радиография) (desktop-приложение)
- Экспорт DICOM в 3D модель (серверная часть или desktop-приложение)
- Веб-приложение для просмотра и анализа (измерение плотности, расстояния, угла) (веб приложение) для пользователей-клиентов
