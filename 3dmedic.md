...
Сейчас (у меня в голове) архитектура проекта на старте выглядит следующим образом:

- Импорт, предварительная обработка и подготовка DICOM (томография радиография) (desktop-приложение vesalius3d osirix-viewer)
- Экспорт DICOM в 3D модель (серверная часть или desktop-приложение)
- Веб-приложение для просмотра и анализа (измерение плотности, расстояния, угла) (веб приложение или desktop-приложение) для пользователей-клиентов
